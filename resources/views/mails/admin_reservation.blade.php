...
<table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
  ...
  <tr data-element="blue-logo" data-label="Logo">
    <td align="center" class="center-text">
      <img style="width:120px;border:0px;display: inline!important;" src="{{asset('mails_assets')}}/images/logo.png" width="120" border="0" editable="true" data-icon data-image-edit data-url data-label="Logo" data-image-width alt="logo">
    </td>
  </tr>
  <tr>
...
<table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row" role="presentation" width="640" style="width:640px;max-width:640px;" data-module="blue-invitation-message">
  <!-- blue-invitation-message -->
  <tr>
    <td height="20" style="font-size:20px;line-height:20px;" data-height="Spacing top">&nbsp;</td>
  </tr>
  <tr>
    ...
    <!-- Content -->
    <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
      <tr data-element="blue-invitation-message-titles" data-label="Titles">
        <td class="center-text" data-text-style="Titles" align="center" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:24px;line-height:48px;font-weight:700;font-style:normal;color:#50C0FF;text-decoration:none;letter-spacing:0px;">

        </td>
      </tr>
      <tr data-element="blue-arrow-divider" data-label="Arrow">
        <td align="center">
          <img style="width:50px;border:0px;display: inline!important;" src="{{asset('mails_assets')}}/images/arrow.png" width="50" border="0" editable="true" data-icon data-image-edit data-url data-label="Arrow" data-image-width alt="arrow">
        </td>
      </tr>
      <tr>
        <td align="center" bgcolor="#F8F8F8" data-bgcolor="Inner BgColor">
        <!-- rwd-col -->
        <table border="0" cellpadding="0" cellspacing="0" align="center" class="row container-padding" width="90%" style="width:90%;max-width:90%;">
          <tr>
            <td height="30" style="font-size:30px;line-height:30px;">&nbsp;</td>
          </tr>
          <tr>
            <td class="rwd-col" align="center" valign="top" width="15%" style="width:15%;max-width:15%;">
            ...
            <td class="rwd-col" align="center" width="5.47%" height="30" style="width:5.47%;max-width:5.47%;height:30px;">&nbsp;</td>
            <td class="rwd-col" align="center" valign="top" width="79.53" style="width:79.53%;max-width:79.53%;">
